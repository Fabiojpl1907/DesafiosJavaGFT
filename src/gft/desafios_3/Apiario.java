package gft.desafios_3;//Desafio
...
//		em relação ao semestre anterior, o recipiente que possuia não suportaria o volume de mel
//		produzido por suas abelhas.
//		Seu Júlio precisa agora que você faça um programa que informado
//		o volume de mel em cm3
...
//		em cada uma um valor de ponto flutuante de dupla precisão com duas casas decimais
//		após a vírgula,
//		sendo um V (1.00 ≤ V ≤ 10000.00)
//		e outro D (1.00 ≤ D ≤ 100.00),
//		representando respectivamente o volume e o diâmetro do recipiente.
//
//		Saída
//		Para cada teste, a saída contém na primeira linha a mensagem
//		"ALTURA = ", com um espaço depois de ALTURA e outro depois do símbolo de igualdade,
...
//		seguido do valor da area da boca(entrada) do recipiente com duas casas decimais
//		após a vírgula.
//

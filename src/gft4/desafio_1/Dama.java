...
// uma delas é a dama, que pode se mover qualquer quantidade de casas na mesma linha, na mesma coluna,
...
//
//        Entrada
//        A entrada contém vários casos de teste. A primeira e única linha de cada caso de
...
//        No tabuleiro, as colunas são numeradas da esquerda para a direita de 1 a 8
//        e as linhas de cima para baixo também de 1 a 8.
...
public class Dama {
    public static void main(String[] args) {
        ...
        while(true){
            ...
            if(  x1 == x2 && y1 == y2  ) System.out.println("0"); // mesma casa - origem e destinoa são iguais
            else if( x1 == x2 || y1 == y2  ) System.out.println("1");  // 1 movimento na linha ou ando na coluna
            
            // o movimento  diagonal sera sempe propocional

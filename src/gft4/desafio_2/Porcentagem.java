...
// Lembre que você sempre pode pedir esclarecimento quando não entender
// direito a descrição de um problema.
...
// Por favor, fique conosco até o fim da competição, trabalhando nas soluções dos problemas até
// o último minuto, pois, enquanto a competição ainda está ocorrendo, sempre há esperança!
//
//		E foi esperança que motivou a Vovó Zazá, uma senhora de 72 anos, a realizar seu sonho de
//		começar um curso universitário.
...
//		mas especialmente com a carteirinha de estudante que ela pode utilizar para pagar meia entrada
//		no cinema.
...
//		agendada para amanhã na Praça General Bertaso.
...
//		O valor deve ser acompanhado do símbolo % e conter exatos dois dígitos após o ponto separador
//		decimal
//
...
public class Porcentagem {
	...
	public static void main(String[] args) throws IOException {
		...
		// Entrar com o valor antigo do ingresso
		double A = leitor.nextDouble();

		// entrar com o valor atual do ingresso
		double B = leitor.nextDouble();


		// porcetagem de aumento do ingresso
		double porcento = ((B/A)-1)*100;

		// %.2f -> apresenta numero com 2 casas decimais
		// %% -> apresentar o simbolbo de procetengem apos o valor

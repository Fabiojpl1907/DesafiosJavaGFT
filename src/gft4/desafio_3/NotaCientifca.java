...
//        mostre este número na notação científica:
//        sempre mostre o sinal da mantissa;
...
//        (de acordo com o padrão IEEE 754-2008).
...
public class NotaCientifca {
	
    public static void main(String[] args) throws IOException {
		Scanner leitor = new Scanner(System.in);

        double entrada = leitor.nextDouble();
        System.out.printf("%+.4E",  entrada   );

...
//		Ele sempre marca com seu amigo Cino de se encontrarem no terminal de ônibus da Parangaba às 8h,
...
//		Cada caso de teste contém uma única linha contendo um horário
//		H (5:00 ≤ H ≤ 9:00) que Bino acordou.
...
public class Feira {
    ...
    public static void main(String[] args) throws IOException {
    	...
    	while (leitor.hasNext()) {
			...
			// precisa chegar as 8:00 o que é aos 480 minutos do dia
			// hora * 60 dá os minutos do dia que levantou
			// possivel atraso de 60 minutos  + fração de minutos do horario que levantou

			int atraso = ((hora*60) + 60 + min) - 480;
			// se der negativo significa que acordou cedo e ira chegar antes das 8
